...
// TimeLineData Array
const TimeLineData = [
    { year: 2018, text: "Completed SSC with GPA of 10" },
    { year: 2020, text: "Completed Intermediate with CGPA of 9.28" },
    { year: 2020, text: "Cracked JEE Mains with a percentile of 94.85" },
    { year: 2023, text: "Gained skills and secured a job at Accenture" },
    { year: "Present", text: "Currently on my last phase of B.tech, Maintaining CGPA of 8.11" }
  ];
  
  // TimeLine Component
  export function TimeLine({ colorMode, onThemeChange }) {
